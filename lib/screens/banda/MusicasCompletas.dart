...
// Este widget auxiliar pode ser movido para seu próprio arquivo se preferir
...
class MusicasCompletasScreen extends StatefulWidget {
  const MusicasCompletasScreen({super.key});

  @override
  State<MusicasCompletasScreen> createState() => _MusicasCompletasScreenState();
}

class _MusicasCompletasScreenState extends State<MusicasCompletasScreen> {
  ...
  void _loadAndSetPlaylist() {
    const playlistId = 'musicas_completas'; // ID para esta playlist
