...
class Guitarra_2Screen extends StatefulWidget {
  const Guitarra_2Screen({super.key});

  @override
  State<Guitarra_2Screen> createState() => _Guitarra_2ScreenState();
}

class _Guitarra_2ScreenState extends State<Guitarra_2Screen> {
