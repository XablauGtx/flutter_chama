...
class Guitarra_1Screen extends StatefulWidget {
  const Guitarra_1Screen({super.key});

  @override
  State<Guitarra_1Screen> createState() => _Guitarra_1ScreenState();
}

class _Guitarra_1ScreenState extends State<Guitarra_1Screen> {
