...
class _PartiturasScreenState extends State<PartiturasScreen> {
  ...
  Future<void> _fetchDocuments() async {
    try {
      final snapshot = await FirebaseFirestore.instance.collection('partituras').orderBy('titulo').get();
      if (mounted) {
        setState(() {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Erro ao carregar partituras: $e')),
        );
      }
    }
  }
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                leading: const Icon(Icons.auto_stories, color: Colors.red),
