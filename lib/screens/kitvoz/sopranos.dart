...
class _SopranoScreenState extends State<SopranoScreen> {
  ...
  void _loadAndSetPlaylist() {
    ...
    if (currentQueue.isNotEmpty) {
      ...
      if (currentNaipe == 'soprano') {
        print("A playlist de Soprano já está carregada.");
        return;
      }
    }
    
    print("Carregando ou trocando para a playlist de Soprano...");
    FirebaseFirestore.instance
      ...
      final mediaItems = validMusicList
          .map((music) => MediaItem(
                id: music.id,
                title: music.titulo,
                extras: {'url': music.url, 'letra': music.letra, 'naipe': 'soprano'},
              ))
          .toList();
