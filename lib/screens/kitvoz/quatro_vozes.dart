...
class QuatroVozesScreen extends StatefulWidget {
  const QuatroVozesScreen({super.key});

  @override
  State<QuatroVozesScreen> createState() => _QuatroVozesScreenState();
}

class _QuatroVozesScreenState extends State<QuatroVozesScreen> {
  ...
  void _loadAndSetPlaylist() {
    ...
    if (currentQueue.isNotEmpty) {
      ...
      if (currentNaipe == '4vozes') {
        print("A playlist de 4 Vozes já está carregada.");
        return;
      }
    }
    
    print("Carregando ou trocando para a playlist de 4 Vozes...");
